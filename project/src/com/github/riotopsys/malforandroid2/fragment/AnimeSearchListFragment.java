...
import com.github.riotopsys.malforandroid2.loader.AnimeSearchLoader;
import com.github.riotopsys.malforandroid2.model.BaseRecord;
import com.google.inject.Inject;

public class AnimeSearchListFragment extends AbstractListFragment  {
	
	@Inject GlobalState state;
	
	@Override
	public Loader<List<BaseRecord>> onCreateLoader(int id, Bundle args) {
		AnimeSearchLoader loader = new AnimeSearchLoader(getActivity(), state );
