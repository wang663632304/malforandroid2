...
public class AnimeDBUpdateTask extends AsyncTask<AnimeRecord, Void, Void> {

	private static final String TAG = AnimeDBUpdateTask.class.getSimpleName();
	...
	public AnimeDBUpdateTask(DatabaseHelper dbHelper, Context ctx, EventBus bus) {
		this.dbHelper = dbHelper;
		this.ctx = ctx;
		this.bus = bus;
	}
	
	public AnimeDBUpdateTask(DatabaseHelper dbHelper, Context ctx, EventBus bus, boolean isAdd) {
		this.dbHelper = dbHelper;
		this.ctx = ctx;
		this.bus = bus;
		this.isAdd = isAdd;
