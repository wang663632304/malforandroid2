...
public class AnimeDBDeleteTask extends AsyncTask<AnimeRecord, Void, Void> {

	private static final String TAG = AnimeDBDeleteTask.class.getSimpleName();
	...
	public AnimeDBDeleteTask(DatabaseHelper dbHelper, Context ctx, EventBus bus) {
